...
wall-recalcitrance and the stronger evidence is the cross-formation pattern, in which silicification
...
cause. It is consequently treated here as supporting rather than flagship evidence; the stronger test
...
The cross-formation comparison is the stronger evidence for the hypothesis, and for a specific
...
outcome and varies silicification at the facies level, is the stronger evidence precisely because it
...
cross-formation pattern, which is less susceptible to that confound, is the stronger evidence but
