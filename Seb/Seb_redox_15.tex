...
cell on the order of hours — an order-of-magnitude feasibility bound rather than a quantitative prediction --- one to two orders of magnitude faster than anoxic decay, which
...
confirms this is stronger than expected by chance. However, these statistics should not
...
cellular fidelity across the Precambrian microfossil record ($\rho = 0.87$). GOE
...
(Spearman $\rho = 0.87$). These statistics should not be read as a confirmatory test:
