% v11 --- REFRAME as Perspective/hypothesis article. Adds four new analytical results:
...
% disambiguation. Reframes all findings as a hypothesis under test, not confirmed results.
...
Precambrian chert-hosted biotas, (ii)~a meta-analytical test with explicit robustness checks,
...
positive in 98.5\% of resamples), robust in direction but uncertain in magnitude. The hypothesis is
...
compilation, a meta-analytical test with robustness checks, a kinetic feasibility calculation, and a
...
independently verified during review as the most rigorous part of the paper --- is presented first,
followed by the meta-analytical statistics and their robustness checks. The systematic compilation
...
\begin{figure}[t]
\centering
\includegraphics[width=0.70\linewidth]{fig_v10_kinetic.png}
...
confirming the direction of the association is robust to coding subjectivity.}
\label{fig:kinetic}
\end{figure}
...
association is therefore robust under an assumption-free test.
...
bootstraps). The wide confidence interval reflects the small sample size and the concentration of the
sample at the extremes of the GOE variable (7 pre-GOE, 1 spanning, 5 post-GOE). The residual
GOE-associated signal is therefore robust in direction but very uncertain in magnitude. GOE position
...
The direction of both associations is therefore robust to coding noise; the magnitude of the observed
...
\begin{figure}[t]
\centering
\includegraphics[width=0.70\linewidth]{fig_gunflint.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\linewidth]{fig_v6_timeline.png}
...
$p < 0.001$), and this association is robust under a permutation test ($p = 0.0006$), a null-model
...
\begin{thebibliography}{99}\footnotesize\linespread{0.90}\selectfont\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}
