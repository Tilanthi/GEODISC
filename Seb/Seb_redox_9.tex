% v9 --- MAJOR REVISION. Transforms the paper from an opinion piece into a META-ANALYSIS with
% genuine new analytical results: a systematic compilation of 15 Precambrian chert-hosted microfossil
% biotas, Spearman / partial-Spearman / Fisher statistics, and a kinetic-feasibility calculation.
% Claim shifts from "silicification explains everything" to "silicification is the dominant taphonomic
% confound, but a significant GOE-associated residual signal persists whose origin is unresolved."
...
$p < 0.001$, $n = 13$), but GOE position retains independent explanatory power after controlling for
silicification (partial $r = 0.72$, $p = 0.006$), indicating a residual GOE-associated signal in
fidelity whose origin the compilation alone cannot resolve. A simple kinetic calculation shows that
catalysed silica nucleation on cell surfaces, documented experimentally, proceeds on timescales of
hours and can outpace anoxic decay (days to weeks) under the silica-saturated conditions of the
Precambrian ocean, making early entombment kinetically feasible wherever local supersaturation and
catalytic surfaces coincide. The biomarker evidence for pre-GOE eukaryotes is contaminated, but the
...
post-GOE microfossil record, but a significant GOE-associated residual persists whose partition
between biology and preservation remains unresolved.
\end{abstract}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\linewidth]{fig_v9_meta.png}
\caption{Systematic compilation of 15 Precambrian chert-hosted microfossil biotas. Silicification
...
The entombment-versus-decay race can be assessed kinetically. Biologically catalysed silica
nucleation on cell surfaces, documented experimentally \citep{Alleon2016silica}, proceeds on
timescales of hours. The half-life of cellular structure under anoxic decay conditions, from
experimental taphonomy, is on the order of days to weeks. Under the silica-saturated conditions of
the Precambrian ocean \citep{Siever1992}, catalysed nucleation therefore outpaces decay by one to
two orders of magnitude, making early entombment kinetically feasible wherever local silica
supersaturation and catalytic surfaces (cell walls, EPS) coincide. The kinetic argument supplies a
mechanism for the statistical association documented above: silicification can win the race against
decay because it is faster, not merely because decay happens to be slow.
...
$p < 0.001$), but that GOE position retains significant explanatory power after controlling for
silicification (partial $r = 0.72$, $p = 0.006$). A kinetic calculation shows that catalysed silica
nucleation on cell surfaces (hours) can outpace anoxic decay (days to weeks) under Precambrian
silica saturation, supplying a mechanism for the statistical association. We conclude that
silicification is a dominant taphonomic confound in the apparent post-GOE diversification of
microfossils, but that a significant GOE-associated residual signal in fidelity persists that cannot
be attributed to silicification alone. Whether this residual reflects genuine biological
...
that would falsify the silicification hypothesis and specify the experimental and analytical
programme needed to test them, one element of which is achievable on existing material.
