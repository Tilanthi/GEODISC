...
class ScientificTermExtractor:
    ...
    def _build_scientific_abbreviations(self) -> Dict[str, str]:
        ...
        return {
            # Geochemistry / sedimentary geology abbreviations
            ...
            # Generic units retained across disciplines
            'UV': 'ultraviolet',
            'IR': 'infrared',
            'X-ray': 'X-ray',
            'K': 'kelvin',
    ...
    def extract_concepts(self, discovery_claim: str) -> List[str]:
        ...
        concept_patterns = [
            r'(organic matter burial|total organic carbon|kerogen|thermal maturity)',
            r'(depositional age|depositional environment|stratigraphy|stratigraphic)',
            r'(pyritization|pyrite framboid|degree of pyritization)',
            r'(banded iron formation|iron formation|iron oxide)',
            r'(chert|silicification|silica cement|diagenetic silica)',
            r'(microbialite|stromatolite|microbial mat|microfossil)',
            r'(redox|anoxia|euxinia|oxygenation|anoxic)',
            r'(great oxidation event|whiff of oxygen|oxygenic revolution)',
            r'(carbon isotope|sulfur isotope|isotope|delta thirteen|delta thirty four)',
            r'(diagenesis|porewater|diagenetic fluid|cementation)',
            r'(sedimentary basin|basin analysis|depositional setting|provenance)',
            r'(taphonomy|fossil preservation|soft tissue preservation|biomineralization)',
            r'(vitrinite reflectance|burial history|thermal history)',
        ]
