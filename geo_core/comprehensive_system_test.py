...
project_root = Path("/Users/gjw255/astrodata/SWARM/GEODISC")
...
class ComprehensiveSystemTest:
    ...
    def __init__(self):
        ...
        self.capabilities_to_test = [
            # Memory Systems
            ("MORK Ontology", "geo_core.memory.mork_ontology", "MORKOntology"),
            ("Context Graph", "geo_core.memory.context_graph", "ContextGraph"),
            ("Working Memory", "geo_core.memory.working", "WorkingMemory"),
            ("Episodic Memory", "geo_core.memory.episodic", "EpisodicMemory"),
            ...
            ("Causal Discovery", "geo_core.reasoning.causal_discovery", None),
            ("V50 Causal Engine", "geo_core.reasoning.v50_causal_engine", None),
            ("V70 Universal Causal", "geo_core.reasoning.v70_universal_causal", None),
            ("Swarm Reasoning", "geo_core.reasoning.swarm_reasoning", None),
            ("Hierarchical Bayesian", "geo_core.reasoning.hierarchical_bayesian_metalearning", None),

            # V4 Revolutionary Capabilities
            ("Meta-Context Engine", "geo_core.metacognitive.meta_context_engine", "MetaContextEngine"),

            # Domains
            ("Domain Registry", "geo_core.domains", "DomainRegistry"),
        ]
    ...
    def _test_memory_graph(self) -> bool:
        from geo_core.memory import MemoryGraph
        return MemoryGraph is not None

    def _test_memory_ontology(self) -> bool:
        from geo_core.memory import MORKOntology
    ...
    def _test_causal_discovery(self) -> bool:
        try:
            from geo_core.reasoning.causal_discovery import PCAlgorithm
    ...
    def _test_v4_metacognitive(self) -> bool:
        try:
            from geo_core.metacognitive.meta_context_engine import MetaContextEngine
    ...
    def test_orchestrator(self):
        ...
        try:
            ...
            print("  create_geo_stan_system()...", end=" ")
