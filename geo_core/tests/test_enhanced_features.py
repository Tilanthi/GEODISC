...
def test_enhanced_features():
    ...
    from geo_core.self_teaching.embedding_novelty import (
    ...
    from geo_core.self_teaching.scientific_data import (
        PhysicsDataLibrary,
    ...
    from geo_core.self_teaching.multi_agent_swarm import (
    ...
    # Agent breakdown
    from geo_core.self_teaching.multi_agent_swarm import AgentRole
    agent_counts = {}
    ...
    from geo_core.self_teaching.arxiv_integration import (
