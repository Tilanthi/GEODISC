...
Main script to run ablation studies on GEODISC system.
"""
...
# Add parent directory to path to import geo_core
...
class AblationTestRunner:
    ...
    def __init__(self, output_dir: Optional[str] = None):
        self.output_dir = output_dir or "geo_core/tests/ablation/results"
    ...
    def create_system_with_ablation(self, ablation_config: AblationConfig):
        """Create GEODISC system with ablated components"""
        try:
            ...
            system = create_geo_stan_system(config=system_config)
    ...
    def run_full_system_baseline(self, queries: Optional[List[str]] = None) -> AblationEvaluation:
        ...
        baseline_config = AblationConfig(
            name="full_system",
            description="Full GEODISC system with all components enabled",
            ablation_type=None
        )
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run GEODISC ablation studies")
