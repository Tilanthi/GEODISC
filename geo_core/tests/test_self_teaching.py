...
class TestSelfRewardingEngine:
    ...
    def test_reward_calculation(self):
        ...
        from geo_core.self_teaching.self_rewarding import (
    ...
    def test_novelty_detection(self):
        ...
        from geo_core.self_teaching.self_rewarding import SelfRewardingEngine
...
class TestStigmergicMemory:
    ...
    def test_pheromone_deposit(self):
        ...
        from geo_core.self_teaching.stigmergic_memory import (
    ...
    def test_biological_field_dynamics(self):
        ...
        from geo_core.self_teaching.stigmergic_memory import StigmergicMemory
...
class TestCurriculumGenerator:
    ...
    def test_problem_generation(self):
        ...
        from geo_core.self_teaching.curriculum_generator import (
    ...
    def test_difficulty_progression(self):
        ...
        from geo_core.self_teaching.curriculum_generator import CurriculumGenerator
...
class TestAutonomousTrainingLoop:
    ...
    def test_single_iteration(self):
        ...
        from geo_core.self_teaching.autonomous_loop import (
            AutonomousTrainingLoop, LoopConfig
        )
        from geo_core.self_teaching.self_rewarding import SelfRewardingEngine
        from geo_core.self_teaching.curriculum_generator import CurriculumGenerator
        from geo_core.self_teaching.recursive_improver import RecursiveImprover
        from geo_core.self_teaching.stigmergic_memory import StigmergicMemory
    ...
    def test_loop_statistics(self):
        ...
        from geo_core.self_teaching.autonomous_loop import AutonomousTrainingLoop
        from geo_core.self_teaching.self_rewarding import SelfRewardingEngine
        from geo_core.self_teaching.curriculum_generator import CurriculumGenerator
        from geo_core.self_teaching.recursive_improver import RecursiveImprover
        from geo_core.self_teaching.stigmergic_memory import StigmergicMemory
...
class TestBenchmarkSuite:
    ...
    def test_quick_assessment(self):
        ...
        from geo_core.self_teaching.benchmark_suite import BenchmarkSuite
        from geo_core.self_teaching import STARLearnSystem
...
class TestIntegratedSystem:
    ...
    def test_full_system_creation(self):
        ...
        from geo_core.self_teaching import (
