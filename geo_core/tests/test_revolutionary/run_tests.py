...
Usage:
    python geo_core/tests/v4/run_tests.py              # Run all tests
    python geo_core/tests/v4/run_tests.py --mce        # Test MCE only
    python geo_core/tests/v4/run_tests.py --asc        # Test ASC only
    python geo_core/tests/v4/run_tests.py --crn        # Test CRN only
    python geo_core/tests/v4/run_tests.py --mmol       # Test MMOL only
    python geo_core/tests/v4/run_tests.py --integration # Test integration only
...
# Tests are in: geo_core/tests/v4/
# Project root is: ../ (from geo_core)
...
def run_mce_tests():
    ...
    try:
        from geo_core.metacognitive.meta_context_engine import (
...
def run_asc_tests():
    ...
    try:
        from geo_core.self_teaching.autocatalytic_compiler import create_autocatalytic_self_compiler
...
def run_crn_tests():
    ...
    try:
        from geo_core.reasoning.cognitive_relativity_navigator import create_cognitive_relativity_navigator
...
def run_mmol_tests():
    ...
    try:
        from geo_core.intelligence.multi_mind_orchestrator import create_multi_mind_orchestrator
        from geo_core.intelligence.specialized_minds import (
...
def run_integration_tests():
    ...
    try:
        from geo_core.v4_revolutionary import create_v4_coordinator, IntegrationMode
