...
def test_module_interconnections():
    ...
    total_tests += 1
    try:
        from geo_core.causal.discovery.bayesian_structure_learning import BayesianStructureLearner, InferenceMethod
        from geo_core.causal.discovery.eig_calculator import create_eig_calculator
    ...
    total_tests += 1
    try:
        from geo_core.causal.discovery.online_causal_learning import OnlineCausalLearner
    ...
    total_tests += 1
    try:
        from geo_core.causal.inference import create_sbi_engine
        from geo_core.causal.discovery.eig_calculator import ObservationPlan, NoiseModel
    ...
    try:
        ...
        print("✓ All V47+ modules importable from geo_core.causal")
        success_count += 1
    except Exception as e:
...
def run_all_tests():
    ...
    print("\n" + "=" * 70)
    print("GEODISC V47+ Enhanced Causal Discovery Test Suite")
    print("=" * 70)
    print()
